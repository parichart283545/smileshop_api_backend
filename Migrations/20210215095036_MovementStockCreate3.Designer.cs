...
namespace BackEnd_DotNetCoreAPI.Migrations
{
    ...
    [Migration("20210215095036_MovementStockCreate3")]
    partial class MovementStockCreate3
    {
            ...
            modelBuilder.Entity("BackEnd_DotNetCoreAPI.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("16328900-db76-4a0a-a9c8-d086f667aa75"),
                            Name = "user"
                        },
                        new
                        {
                            Id = new Guid("ef729557-7030-4f7f-a5ce-a19cc155b790"),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("0d3cfa06-312b-4fb9-bc03-d46d5fa944d5"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("d0afe388-d89f-4fe9-af30-b36366811f65"),
                            Name = "Developer"
                        });
                });
