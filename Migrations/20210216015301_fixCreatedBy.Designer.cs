...
namespace BackEnd_DotNetCoreAPI.Migrations
{
    ...
    [Migration("20210216015301_fixCreatedBy")]
    partial class fixCreatedBy
    {
            ...
            modelBuilder.Entity("BackEnd_DotNetCoreAPI.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fcb53907-d829-4273-9eeb-5f34b61dab7a"),
                            Name = "user"
                        },
                        new
                        {
                            Id = new Guid("2958c31b-d53e-44a8-9809-4132540ee242"),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("bda1c2d8-248f-4fa8-ada8-64920f54da2b"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("ddcac69d-db5b-4d1c-9753-27f0796b80d3"),
                            Name = "Developer"
                        });
                });
